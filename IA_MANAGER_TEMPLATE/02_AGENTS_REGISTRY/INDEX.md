...
| `AG-VC-02-FRONTEND` | Especialista Frontend (Angular) | Implementa UI Angular 16.2 con NgModules, Bootstrap y Angular Material. | `angular`, `componente`, `interfaz`, `formulario` | \"Crea una página de gestión de clientes en Angular\" |
...
| `AG-VC-10-ENTITY-STACK` | Generador Entidad-FullStack | Orquestación full-stack desde entidad (DB → Backend → Frontend); genera checklist y valida artefactos. | `generar todo para entidad`, `entidad a full-stack`, `CRUD desde entidad`, `crear CRUD completo` | \"Generar todo para la entidad Productos\"; \"CRUD completo desde entidad Clientes\" |
